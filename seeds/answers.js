  ...
  return knex('answers').del()
    .then(function () {
      ...
      return knex('answers').insert([
        ...
        {id: 146, questions_Id: 38, response: 'Arthus Pass', correct: 'no', description: 'Not even close.'},
        {id: 147, questions_Id: 38, response: 'Tongariro National Park', correct: 'no', description: 'Not even close.'},
