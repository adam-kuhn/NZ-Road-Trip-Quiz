  ...
  return knex('answers').del()
    .then(function () {
      ...
      return knex('answers').insert([
        ...
        {id: 73, questions_Id: 19, response: 'Business card', correct: 'yes', description: 'Yeah...can not recommend it, but there was nothing else!', image: '/images/descriptions/tp.jpg'},
        ...
        {id: 77, questions_Id: 20, response: 'Hiking with only 500 ml of water and a pack of Jelly Bellies', correct: 'yes', description: 'Yup. That is all I had. No jacket, no supplies, no nothing. But I made it.', image: '/images/descriptions/jellybean.jpg'},
        ...
        {id: 153, questions_Id: 40, response: '0', correct: 'yes', description: 'Yup...lone wolf'},
        {id: 154, questions_Id: 40, response: '2', correct: 'no', description: 'Nope. I did meet a few cool people on the trails though'},
        {id: 155, questions_Id: 40, response: '4', correct: 'no', description: 'Nope. I did meet a few cool people on the trails though'},
        {id: 156, questions_Id: 40, response: '6', correct: 'no', description: 'Nope. I did meet a few cool people on the trails though'}
      ])
    })
}
