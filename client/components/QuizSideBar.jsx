  ...
  render () {
    return (
      <ul className='sidebar'>
        ...
        <li><Link to ={'/quiz/speed'}>Speed Round</Link>&nbsp;{this.props.speedScore}/10 - Test your merit, as questions are pulled from all of the above quizes, and you are only given X amount of time to answer each question.</li>
      </ul>
    )
  }
}
